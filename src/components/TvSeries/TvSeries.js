        ...
        <div style={{ paddingTop: "8rem" }}>
            <Grid container p={2} mb={5}>
                <Grid item md={8} xs={12} mb={2}>
                    <Typography ml={5} variant="h5" fontWeight={700} sx={{ color: "red" }}> TvSeries </Typography>
                </Grid>
                    ...
                    <Grid container>
                        <Grid item md={10}>
                            <Input
                                ...
                                placeholder="  Search tvSeries Here ...">
                            </Input>
                        </Grid>
                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", padding: "8px" }}>
                            ...
                            {genresTv !== "" ?
                                genresTv.map((el, index) =>
                                    <Button key={index}
                                        onClick={() => { setSelectGenres({ name: el.name, id: el.id }); toggle(); navigate(`/tvSeries/page/1`); }} style={{ margin: "10px 10px" }}
            ...
            <Grid container justifyContent="center" mt={4} className="animate__animated animate__fadeInLeft">
                {tvSeries.length > 0 ?
